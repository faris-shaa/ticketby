        ...
        <div class="mb-4 col-span-4 bg-light bg-opacity-5 rounded-2xl border border-primary_color_o10_1 p-2 md:p-32-32 ">
            ...
            <div class="">
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <div class="p-3 ">
                        <button class="tab-button  px-2 py-3  focus:outline-none  text-h6 bg-primary_color_8 text-white   rounded-md  w-full mt-9" data-tab="tab2">Log out</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-span-8 bg-light bg-opacity-5 rounded-2xl border border-primary_color_o10_1 p-2 md:p-32-32 ">
            <div class="tab-content ">
                <div id="tab1" class="tab-pane hidden  ">
                    ...
                    <div class="mb-4 flex border rounded-5xl border-primary_color_a11 justify-center w-fit mx-auto p-1 gap-1 a">
                        <button class="tab-button2 flex items-center justify-center gap-1 text-white px-2 py-3 rounded-5xl focus:outline-none  text-h6 active" data-tab="tab6">
                            {{__('Profile settings')}}</button>
                        <button class="tab-button2 flex items-center justify-center gap-1 text-white px-2 py-3 rounded-5xl focus:outline-none  text-h6 " data-tab="tab7">
                    ...
                    <div class="tab-content2 ">
                        ...
                        <div id="tab7" class="tab-pane2 hidden text-center">
                            <h3 class=" lg:h3 text-primary_color_5 mt-2"> {{__('Change password?')}} </h3>
                            <p class=" mt-1 mb-8"> {{__('Click down to change your password.')}}</p>
                            ...
                            <div class="mt-4 p-2 respo border border-yelow rounded-lg flex items-center">
                                ...
                                <div class="text-start">
                                    <h5 class="text-gray_b5"> {{__('Check your email')}}
                                    </h5>
                                    <p class="text-h6 text-gray_b5">{{__('An email has been sent to you with detailed instructions on how to reset your password.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-col-1 md:grid-cols-2  xl:grid-cols-3 gap-4 mt-4">
                                <div class="bg-light bg-opacity-5 rounded-2xl border border-primary_color_o10_1 overflow-hidden">
                                    ...
                                    <div class="px-1">
                                        ...
                                        <div class="mt-2  mb-7 flex items-center">
                                            <div class="">
                                                <p class="flex gap-1  items-center">
                                                    ...
                                                    <a target="_blank" href=" # "><span class="text-h8">جدة Saudi Arabia</span></a>
                                                </p>
                                                <p class="flex gap-1    items-center">
                                        ...
                                        <div class="py-2 border-t-1 border-dashed border-gray_fb round-tiket">
                                            <div class="bg-primary_color_2   rounded-lg w-32 h-32 mx-auto ">
                                                <img class="w-full h-full object-cover" src="https://th.bing.com/th/id/R.dcf4b6e228aef80dd1a58f4c76f07128?rik=Qj2LybacmBALtA&riu=http%3a%2f%2fpngimg.com%2fuploads%2fqr_code%2fqr_code_PNG25.png&ehk=eKH2pdoegouCUxO1rt6BJXt4avVYywmyOS8biIPp5zc%3d&risl=&pid=ImgRaw&r=0" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
