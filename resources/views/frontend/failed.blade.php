...
<header class="site-header thankyou" id="header">
		<h1 class="site-header__title text-primary" data-lead-id="site-header-title">{{__('ORDER CANCELLED')}}</h1>
	</header>

	<div class="main-content">

		<i class="fa fa-circle-xmark main-content__checkmark" id="checkmark"></i>
		<p class="main-content__body text-primary" data-lead-id="main-content-body">{{__('Please try again')}}</p>
	</div>
